...
class Command(BaseCommand):
	...
	def make_data(self):
		...
		user = User.objects.create(username="dean", password="armada13", email="deanarmada@looplabs.com.au", first_name="Dean", last_name="Armada")
		...
		UserAccount.objects.create(user=user, user_type=user_type, school=school, middle_name="Guinto", street=street, suburb=suburb, state=state, post_code=post_code)
